...
<body>
	...
	<p>
	<p> ENTER CAPTCHA! </p>
	You are "O" and it's your turn.<br>Tap on the right place to submit!</p>
	<div id = "new">
	<?php require 'db.php'; ?>
	...
	<a href="thankyou.html" id='go'> <button type='button' id='continue' class="btn btn--radius btn--green" type="submit"> SUBMIT </button></a>	<!-- The continue button -->
